...
本项目提供在线 Demo 页面，可直接在浏览器中体验语音对话功能（需要麦克风权限）：

| 页面 | 访问地址 | 说明 |
|:---:|:---|:---|
| **语音聊天 Demo** | https://hermind.top/demo/ | 用户端语音对话界面，移动端适配，支持实时语音交互 |
| **开发者测试页** | https://hermind.top/test/test_page.html | WebSocket 连接调试、MCP 工具测试、音频录制调试 |

> 💡 提示：浏览器访问需要 HTTPS 才能使用麦克风功能，请使用上述域名地址访问。
